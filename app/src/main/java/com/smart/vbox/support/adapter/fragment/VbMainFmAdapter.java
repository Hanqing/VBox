...
import com.smart.vbox.ui.fragment.main.VbHomeFragment;
 ...
 */
public class VbMainFmAdapter extends FragmentStatePagerAdapter {

    public VbMainFmAdapter(FragmentManager fm) {
        super(fm);
    }
