...
public class MediaController extends FrameLayout {
    ...
    private ImageButton mFillButton;
    ...
    private OnClickListener mFillListener = new OnClickListener() {
    ...
    protected View makeControllerView() {
        ...
        if (mCurrentOrientation == Configuration.ORIENTATION_LANDSCAPE) {
            return ((LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(getResources().getIdentifier("mediacontroller_full", "layout", mContext.getPackageName()), this);
        }
        return ((LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(getResources().getIdentifier("mediacontroller_default", "layout", mContext.getPackageName()), this);
    ...
    private void initControllerView(View v) {
        ...
        mPlayState = (ImageView) v.findViewById(getResources().getIdentifier("mediacontroller_play_state", "id", mContext.getPackageName()));
        mPlayState.setOnClickListener(mPauseListener);

        mFillButton = (ImageButton) v.findViewById(getResources().getIdentifier("mediacontroller_fill", "id", mContext.getPackageName()));
        if (mFillButton != null) {
            mFillButton.requestFocus();
            mFillButton.setOnClickListener(mFillListener);
        }
